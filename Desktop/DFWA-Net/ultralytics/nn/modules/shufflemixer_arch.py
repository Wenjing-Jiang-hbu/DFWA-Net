...
class SplitPointMlp(nn.Module):
    def __init__(self, dim, mlp_ratio=1.25):
        super().__init__()
...
class SMLayer(nn.Module):
    def __init__(self, dim, kernel_size, mlp_ratio=1.25):
        super().__init__()
...
class FMBlock(nn.Module):
    def __init__(self, dim, kernel_size, mlp_ratio=1.25, conv_ratio=1.25, cg = 16):
        super().__init__()
